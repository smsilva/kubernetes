...
kubectl apply -f providers/controller-config-debug.yaml
...
kubectl apply -f providers/kubernetes/config/providerconfig.yaml

kubectl apply -f providers/kubernetes/examples/single-object/config/composite-resource-definition.yaml

kubectl apply -f providers/kubernetes/examples/single-object/config/composition.yaml
...
watch -n 3 scripts/show-provision-progress-kubernetes-provider.sh
